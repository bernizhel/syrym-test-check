    ...
    <div className={bem()}>
      ...
      <nav className='navbar navbar-expand-sm navbar-light bg-light'>
        <div className='container'>
          <Link data-testid='logo' className={bem("Brand", ["navbar-brand"])} to='/'>
            Example store
          </Link>
          ...
          <div className={bem("Menu", [navbarClass])}>
            <div className='navbar-nav'>
              <NavLink className='nav-link' activeClassName='active' to='/catalog' onClick={hide}>
                Catalog
              </NavLink>
              <NavLink className='nav-link' activeClassName='active' to='/delivery' onClick={hide}>
                Delivery
              </NavLink>
              <NavLink className='nav-link' activeClassName='active' to='/contacts' onClick={hide}>
                Contacts
              </NavLink>
              <NavLink className='nav-link' activeClassName='active' to='/cart' onClick={hide}>
                {cartLabel}
              </NavLink>
            </div>
          </div>
